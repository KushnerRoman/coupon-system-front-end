...
import {useTable,useSortBy,useGlobalFilter,useFilters,usePagination,useRowSelect, useMountedLayoutEffect} from 'react-table'
...
const actionAdminBar=()=>{
    return(
        <div className={classes.actionRows}>
            <button className={classes.button} onClick={()=>props.onActions(selectedRowsValue)}> Delete  </button> 
            <button className={classes.button} onClick={getCellValue}> Update  </button> 
        </div>
